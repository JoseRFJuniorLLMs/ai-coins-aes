...
export const appConfig: ApplicationConfig = {
  providers: [
    importProvidersFrom(
      ...
      provideFirebaseApp(() =>
        initializeApp({
          apiKey: 'AIzaSyAiXs8ojZCO-VR8XNR8uB6Mqzj7F8qVxx4',
          authDomain: 'ai-coins-aes.firebaseapp.com',
          projectId: 'ai-coins-aes',
          storageBucket: 'ai-coins-aes.appspot.com',
          messagingSenderId: '605147212870',
          appId: '1:605147212870:web:eefa766c015924dc762e47',
          measurementId: 'G-JCD0XNN4D4'
        })
      ),
